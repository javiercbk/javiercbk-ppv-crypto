...
var PermissionsUserWhere = struct {
	ID       whereHelperint64
	UserID   whereHelperint64
	Resource whereHelperstring
	Access   whereHelperstring
}{
	ID:       whereHelperint64{field: "\"permissions_users\".\"id\""},
	UserID:   whereHelperint64{field: "\"permissions_users\".\"user_id\""},
	Resource: whereHelperstring{field: "\"permissions_users\".\"resource\""},
	Access:   whereHelperstring{field: "\"permissions_users\".\"access\""},
}
...
var (
	permissionsUserAllColumns            = []string{"id", "user_id", "resource", "access"}
