...
type Payment struct {
	...
	InvoiceID               null.String `boil:"invoice_id" json:"invoiceID,omitempty" toml:"invoiceID" yaml:"invoiceID,omitempty"`
...
var PaymentWhere = struct {
	...
	InvoiceID:               whereHelpernull_String{field: "\"payments\".\"invoice_id\""},
	Expiry:                  whereHelpernull_Time{field: "\"payments\".\"expiry\""},
...
var (
	paymentAllColumns            = []string{"id", "user_id", "pay_per_view_event_id", "currency", "currency_payment_id", "amount", "invoice_id", "expiry", "status", "block_hash", "block_number_hex", "tx_hash", "tx_number_hex", "cancelled_block_hash", "cancelled_block_number_hex", "cancelled_tx_hash", "cancelled_tx_number_hex", "cancelled_at", "created_at", "updated_at"}
	paymentColumnsWithoutDefault = []string{"user_id", "pay_per_view_event_id", "currency", "currency_payment_id", "amount", "invoice_id", "expiry", "block_hash", "block_number_hex", "tx_hash", "tx_number_hex", "cancelled_block_hash", "cancelled_block_number_hex", "cancelled_tx_hash", "cancelled_tx_number_hex", "cancelled_at", "created_at", "updated_at"}
