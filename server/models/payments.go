...
var (
	paymentColumns               = []string{"id", "user_id", "pay_per_view_event_id", "currency", "currency_payment_id", "amount", "wallet_address", "status", "block_hash", "block_number_hex", "tx_hash", "tx_number_hex", "cancelled_block_hash", "cancelled_block_number_hex", "cancelled_tx_hash", "cancelled_tx_number_hex", "cancelled_at", "created_at", "updated_at"}
	paymentColumnsWithoutDefault = []string{"user_id", "pay_per_view_event_id", "currency", "currency_payment_id", "amount", "wallet_address", "block_hash", "block_number_hex", "tx_hash", "tx_number_hex", "cancelled_block_hash", "cancelled_block_number_hex", "cancelled_tx_hash", "cancelled_tx_number_hex", "cancelled_at", "created_at", "updated_at"}
