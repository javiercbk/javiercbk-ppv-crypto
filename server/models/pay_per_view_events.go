...
var PayPerViewEventWhere = struct {
	...
	EthContractAddr whereHelpernull_String
	...
	EthContractAddr: whereHelpernull_String{field: "\"pay_per_view_events\".\"eth_contract_addr\""},
...
var (
	payPerViewEventAllColumns            = []string{"id", "name", "description", "event_type", "start", "end", "price_ETH", "price_BTC", "price_XMR", "eth_contract_addr", "created_at", "updated_at"}
